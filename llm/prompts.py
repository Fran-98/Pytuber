...
SCRIPT_USER = 'Write a script for a youtube short about an interesting fact about {}, explain the fact and give \
    some interesting information about it, it doesnt matter if the information is invented or fake. The script only consist of the text thats going to be reading the video. \
    Put it all inside the script key of the JSON. Start the script asking something. The most important thing is to keep the viewers engaged.'
...
SUBJECTS_USER = 'Write 100 detailed subjects for viral youtube shorts about puntual interesting facts, one fact for video, those facts could be totally invented and fake. \
