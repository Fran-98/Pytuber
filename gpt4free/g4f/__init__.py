import sys
from . import Provider, models


class ChatCompletion:
    @staticmethod
    def create(model: models.Model.model or str, messages: list, provider: Provider.Provider = None, stream: bool = False, auth: str = False, **kwargs):
        kwargs['auth'] = auth
